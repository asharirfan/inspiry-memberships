...
<div class="ims-wire-settings">
		...
		<tr>
			<th scope="row">
				<label for="ims_wire_enable">
					<?php _e( 'Enable Wire Transfer', 'inspiry-memberships' ); ?>
				</label>
			</th>
			<td>
				<fieldset>
					<label for="ims_wire_enable">
						...
						<?php _e( 'Check this box to enable wire transfer.', 'inspiry-memberships' ); ?>
					</label>
				</fieldset>
			</td>
		</tr>
		...
		<tr>
			<th scope="row">
				<label for="ims_wire_instructions">
					<?php _e( 'Instructions for Wire Transfer', 'inspiry-memberships' ); ?>
				</label>
			</th>
			<td>
				<fieldset>
					<label for="ims_wire_instructions">
						...
						<p class="description">
							<?php _e( 'Enter the instructions for wire transfer.', 'inspiry-memberships' ); ?>
						</p>
					</label>
				</fieldset>
			</td>
		...
		<tr>
			<th scope="row">
				<label for="ims_wire_account_name">
					<?php _e( 'Account Name', 'inspiry-memberships' ); ?>
				</label>
			</th>
			<td>
				<fieldset>
					<label for="ims_wire_account_name">
						...
						<p class="description">
							<?php _e( 'Enter your account name.', 'inspiry-memberships' ); ?>
						</p>
					</label>
				</fieldset>
			</td>
		...
		<tr>
			<th scope="row">
				<label for="ims_wire_account_number">
					<?php _e( 'Account Number', 'inspiry-memberships' ); ?>
				</label>
			</th>
			<td>
				<fieldset>
					<label for="ims_wire_account_number">
						...
						<p class="description">
							<?php _e( 'Enter your account number.', 'inspiry-memberships' ); ?>
						</p>
					</label>
				</fieldset>
			</td>
	...
	<p class="ims__description">
		<a href="#" class="button button-primary" id="ims-wire-submit">
			<?php _e( 'Finish', 'inspiry-memberships' ); ?>
		</a>
